...
CLIENT_SYNC_OPTIC =  b"client sync optc"
SERVER_SYNC_OP_ACK = b"serv sync op ack"
CLIENT_FINAL_SYNC =  b"client final syn"
SERVER_ACK_S_FINAL = b"server ack s fin"
...
SERVER_MESSAGE =     b"server message  "
CLIENT_RQST_ILUM =   b"client rqst ilum"
SERVER_ILUM =        b"server ilum     "
CLIENT_RESET_SYS =   b"client reset sys"
SERVER_SYS_RST_ACK = b"server sys r ack"
CLIENT_ABORT_PROCS = b"client abort prs"
SERVER_READY =       b"server ready    "
